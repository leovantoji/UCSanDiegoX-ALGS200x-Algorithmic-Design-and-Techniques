...
**Output Format:** Output the maximum value of *\sum_{i=1}^{n} a<sub>i</sub>, c<sub>i</sub>*, where *c<sub>1</sub>, c<sub>2</sub>,..., c<sub>n</sub>* is a permutation of *b<sub>1</sub>, b<sub>2</sub>,..., b<sub>n</sub>*.
